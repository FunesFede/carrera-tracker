					...
					<div className='md:col-span-7'>
						<Card className='border-r md:border-r-0 rounded-r-none md:rounded-l-lg'>
							<CardContent className='p-6 md:p-8'>
								<PasswordlessLogin onSignInSuccess={signInSuccessFunc} from={location.state?.from} />
							</CardContent>
						</Card>
					</div>
					<div className='hidden md:flex md:col-span-5 bg-card border border-l-0 rounded-r-lg items-center justify-center p-6'>
						<img draggable='false' src='/images/undraw_2fa.svg' className='max-w-xs w-full' alt='Login illustration' />
					</div>
				</div>
			</div>
		</div>
